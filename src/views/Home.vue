    ...
    <div class="block">
      <el-carousel height="460px">
        <el-carousel-item v-for="item in carousel" :key="item.carousel_id">
          <img style="height:460px;" :src="item.imagePath" :alt="item.describes" />
...
export default {
  data() {
    return {
      carousel: [
        {carousel_id:1,imagePath:require("../../static/imgs/cms_1.jpg"),describes:"11"},
        {carousel_id:2,imagePath:require("../../static/imgs/cms_2.jpg"),describes:"222"},
        {carousel_id:3,imagePath:require("../../static/imgs/cms_3.jpg"),describes:"333"},
        {carousel_id:4,imagePath:require("../../static/imgs/cms_4.jpg"),describes:"444"}
      ], // 轮播图数据
      // carousel:{},
      phoneList: "", // 手机商品列表
      miTvList: "", // 小米电视商品列表
